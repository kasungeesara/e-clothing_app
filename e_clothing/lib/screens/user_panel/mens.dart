...
final List<ClothingItem> tShirts = [
  ClothingItem(name: "T-Shirt 1", price: 2000.0, imageUrl: "assets/t(1).jpg"),
  ClothingItem(name: "T-Shirt 2", price: 2500.0, imageUrl: "assets/t(5).jpg"),
  ClothingItem(name: "T-Shirt 3", price: 2355.0, imageUrl: "assets/t(3).jpg"),
];

final List<ClothingItem> shirts = [
  ClothingItem(name: "Shirt 1", price: 3500.0, imageUrl: "assets/shirt1.jpg"),
  ClothingItem(name: "Shirt 2", price: 4000.0, imageUrl: "assets/shirt3.jpg"),
  ClothingItem(name: "Shirt 3", price: 4600.0, imageUrl: "assets/shirts.jpg"),

];

final List<ClothingItem> trousers = [
  ClothingItem(name: "Trousers 1", price: 5000.0, imageUrl: "assets/tr1.jpg"),
  ClothingItem(name: "Trousers 2", price: 5500.0, imageUrl: "assets/tr2.jpg"),
  ClothingItem(name: "Trousers 3", price: 6500.0, imageUrl: "assets/tr4.jpg"),
];

final List<ClothingItem> shorts = [
  ClothingItem(name: "Shorts 1", price: 830.0, imageUrl: "assets/sh1.jpg"),
  ClothingItem(name: "Shorts 2", price: 935.0, imageUrl: "assets/sh2.jpg"),
   ClothingItem(name: "Shorts 3", price: 645.0, imageUrl: "assets/sh3.jpg"),
];
